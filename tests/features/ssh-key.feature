Feature: SSH Keys
  ...
  Scenario: List SSH keys
    Given I have at least "1" SSH key
    ...
    """
      ...
      Description
    """
    And I should not get the warning: "You have no SSH keys."

  @tag
  @vcr ssh-key-list.yml
  Scenario: Attempt to List SSH keys
  ...
  Scenario: Add an SSH key
    ...
    Then I should get the notice: "Added SSH key from file tests/config/dummy_key.pub"

  @vcr ssh-key-delete.yml
  Scenario: Delete an SSH key
    When I run "terminus ssh-key:remove 11111111111111111111111111111"
    Then I should get the notice: "Deleted SSH key 11111111111111111111111111111!"
